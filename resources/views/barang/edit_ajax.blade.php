        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $barang->menu_kode }}" type="text" name="menu_kode" id="menu_kode" class="form-control" required>
                    <small id="error-menu_kode" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Nama Barang</label>
                    <input value="{{ $barang->menu_nama }}" type="text" name="menu_nama" id="menu_nama" class="form-control" required>
