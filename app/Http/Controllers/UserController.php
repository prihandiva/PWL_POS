...
{
    // Cek apakah permintaan datang dari AJAX atau ingin JSON
    if ($request->ajax() || $request->wantsJson()) {
        ...
        if ($user) {
            ...
            // Kembalikan respons JSON dengan status sukses dan pesan
            return response()->json([
                'status' => true,
                'message' => 'Data berhasil dihapus'
            ]);
        } else {
            // Jika data pengguna tidak ditemukan, kembalikan respons JSON dengan status gagal dan pesan
            return response()->json([
                'status' => false,
                'message' => 'Data tidak ditemukan'
            ]);
        ...
        // Jika bukan permintaan AJAX atau JSON, redirect ke halaman utama (atau halaman lain yang sesuai)
        return redirect('/');
    }
}
    //create
